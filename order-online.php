<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete">
   ...
   <body class="abt-bg">
      ...
      <div id="wm-ipp-base" lang="en" style="display:none;direction:ltr;">
         <div id="wm-ipp" style="position:fixed;left:0;top:0;right:0;">
            <div id="donato" style="position:relative;width:100%;">
               <div id="donato-base">
                  <iframe id="donato-if" src="https://archive.org/includes/donate.php?as_page=1&amp;platform=wb&amp;referer=https%3A//web.archive.org/web/20230223130814/http%3A//www.teawheeler.co.in/order-online.php"
            ...
            <div id="wm-ipp-inside">
               <div id="wm-toolbar" style="position:relative;display:flex;flex-flow:row nowrap;justify-content:space-between;">
                  ...
                  <div class="c" style="display:flex;flex-flow:column nowrap;justify-content:space-between;flex:1;">
                     <form class="u" style="display:flex;flex-direction:row;flex-wrap:nowrap;" target="_top" method="get" action="/web/submit" name="wmtb" id="wmtb"><input type="text" name="url" id="wmtbURL" value="http://www.teawheeler.co.in/order-online.php" onfocus="this.focus();this.select();" style="flex:1;"/><input type="hidden" name="type" value="replay" /><input type="hidden" name="date" value="20230223130814" /><input type="submit" value="Go" />
                     </form>
                     <div style="display:flex;flex-flow:row nowrap;align-items:flex-end;">
                        <div class="s" id="wm-nav-captures" style="flex:1;">
                           <a class="t" href="/web/20230223130814*/http://www.teawheeler.co.in/order-online.php" title="See a list of every capture for this URL">2 captures</a>
                  ...
                  <div class="r" style="display:flex;flex-flow:column nowrap;align-items:flex-end;justify-content:space-between;">
                     ...
                     <div id="wm-share" class="xxs">
                        <a href="/web/20230223130814/http://web.archive.org/screenshot/http://www.teawheeler.co.in/order-online.php"
                           id="wm-screenshot"
                           title="screenshot">
                        ...
                        <a id="wm-share-facebook" href="#" data-url="https://web.archive.org/web/20230223130814/http://www.teawheeler.co.in/order-online.php" title="Share on Facebook" style="margin-right:5px;" target="_blank"><span class="iconochive-facebook" style="color:#3b5998;font-size:160%;"></span></a>
                        <a id="wm-share-twitter" href="#" data-url="https://web.archive.org/web/20230223130814/http://www.teawheeler.co.in/order-online.php" title="Share on Twitter" style="margin-right:5px;" target="_blank"><span class="iconochive-twitter" style="color:#1dcaff;font-size:160%;"></span></a>
                     </div>
      ...
      <div id="wm-ipp-print">The Wayback Machine - https://web.archive.org/web/20230223130814/http://www.teawheeler.co.in/order-online.php</div>
      <script type="text/javascript">//<![CDATA[
         __wm.bt(725,27,25,2,"web","http://www.teawheeler.co.in/order-online.php","20230223130814",1996,"https://web-static.archive.org/_static/",["https://web-static.archive.org/_static/css/banner-styles.css?v=S1zqJCYt","https://web-static.archive.org/_static/css/iconochive.css?v=qtvMKcIJ"], false);
           __wm.rw(1);
         //]]>
      </script>
      ...
      <nav class="navbar navbar-lg navbar-expand-lg navbar-transparant navbar-dark navbar-absolute w-100 bg-white">
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
               ...
               <ul class="navbar-nav">
                  <li class="nav-item">
                     <a class="nav-link active" href="order-online.php">Order Online</a>
                  </li>
                  <li class="nav-item">
