<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete">
   ...
   <body class="abt-bg">
      ...
      <div id="wm-ipp-print">The Wayback Machine - https://web.archive.org/web/20230223130814/http://www.teawheeler.co.in/on-the-go.php</div>
      ...
      <!--menu end-->
      <section class="h551" style="position:relative; background:url(https://www.dummyimage.com/1920x1080.png) top center no-repeat; background-size:cover; width:100%; border-bottom:3px groove #000;">
         <!---->
               ...
               <div id="MiddleCarousel" class="carousel slide UACarousel" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <img class="d-block w-100 mm55" src="https://www.dummyimage.com/760x500.png/000/eee" alt="First slide">
                     </div>
                     <div class="carousel-item">
                        <img class="d-block w-100 mm55" src="https://www.dummyimage.com/760x500.png/444/eee" alt="Second slide">
                     </div>
                     <div class="carousel-item">
                        <img class="d-block w-100 mm55" src="https://www.dummyimage.com/760x500.png/000/eee" alt="First slide">
                     </div>
                     ...
                     <div class="carousel-item">
                        <img class="d-block w-100 mm55" src="https://www.dummyimage.com/760x500.png/000/eee" alt="Second slide">
                     </div>
                  </div>
