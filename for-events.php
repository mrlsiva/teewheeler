<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete">
   ...
   <body class="abt-bg">
      ...
      <div id="wm-ipp-print">The Wayback Machine - https://web.archive.org/web/20230223130814/http://www.teawheeler.co.in/for-events.php</div>
         ...
         <div class="container pt-50 pb-50">
            <div class="row">
               ...
               <div class="col-md-12 pt-4">
                  <!--style="background:url(img/mid-line.png) center no-repeat;"-->
         ...
         <div class="container ptb-75">
            <div class="row">
               ...
               <div class="col-md-6 col-xs-12 " align="center">
                  <img src="img/flask-tea.png" alt="1" class="img-fluid"/>
               </div>
            </div>
         </div>
      </section>
